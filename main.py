...
from game_loops import deep_q_learn, eval, reinforce_learn, actor_critic_learn, PPO_learn
from exploration import Explorations, Exploration

class parameters:
    # general parameters
    name: str = "PPO_lunarlander" # (name of the trained agent)
    train_loop: Callable = PPO_learn # (choose between deep q learning, policy gradient, actor critic, eval)
    ...
    num_envs: int = 4 # (how many environments to run in parallel)
